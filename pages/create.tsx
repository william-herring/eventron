                    ...
                    <form>
                        ...
                        <div className='flex mb-3 items-center justify-center'>
                            <div className='flex items-center'>
                                <input className='text-xl p-3 mb-3 text-gray-500 outline-0 border-b-2 border-gray-400 focus:border-blue-700 focus:caret-blue-700' type='text' placeholder='Start (dd/mm/yy)' />
                            </div>
                            <div className='flex items-center'>
                                <input className='text-xl p-3 mb-3 text-gray-500 outline-0 border-b-2 border-gray-400 focus:border-blue-700 focus:caret-blue-700' type='text' placeholder='End (dd/mm/yy)' />
                            </div>
                        </div>
                        ...
                        <ActionButton glow={false} onClick={() => {}}>Submit</ActionButton>
                    </form>
                </div>
            </div>
        </div>
